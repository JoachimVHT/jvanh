...
namespace Verlofsite.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("gebruiker heeft zijn wachtwoord succesvol aangepast");
            StatusMessage = "Uw wachtwoord werd succesvol aangepast";
